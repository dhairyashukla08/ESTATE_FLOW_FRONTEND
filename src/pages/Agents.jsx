...
const Agents = () => {
  ...
  const search = searchTerm.toLowerCase();
    ...
    return name.includes(search) || location.includes(search) || specialty.includes(search);
  });
    ...
    <div className="min-h-screen bg-gray-50 px-6 py-16">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredAgents.length > 0 ? (
            ...
            <div className="col-span-full text-center py-20">
               <p className="text-gray-400 font-bold">No agents found matching your search...</p>
            </div>
          )}
        </div>
        ...
        <div className="bg-black rounded-3xl p-14 text-center text-white">
          <h2 className="text-3xl font-semibold mb-4">Are you a Real Estate Professional?</h2>
