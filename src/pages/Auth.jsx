        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            {isLogin && (
              <div className="flex justify-end mt-2">
                <Link to="/forgot-password" size="sm" className="text-sm text-gray-500 hover:text-black transition">
                  Forgot Password?
                </Link>
              </div>
            )}
          ...
          {!isLogin && (
            <div className="flex items-start gap-2 text-sm text-gray-600">
              ...
              <p>
                I agree to the <span className="text-black font-medium cursor-pointer hover:underline">Terms</span> and <span className="text-black font-medium cursor-pointer hover:underline">Privacy</span>.
              </p>
            </div>
          )}
