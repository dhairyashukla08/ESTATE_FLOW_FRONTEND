            ...
            {loading ? (
                ...
                {properties.length > 0 && !loading && (
                  <div className=" flex justify-end border-t border-gray-100 pt-8">
                    <button
                      ...
                      className="group flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white border border-gray-200 text-slate-700 hover:text-black font-bold text-sm shadow-sm hover:border-black transition-all active:scale-95 cursor-pointer"
                    >
                      Back to Top
                      <svg
              ...
              <div className="bg-white rounded-2xl shadow-sm p-12 text-center space-y-6">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  We couldn't find anything matching your exact criteria. Try
